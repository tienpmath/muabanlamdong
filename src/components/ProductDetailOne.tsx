...
const ProductDetailOne = (props: any) => {
  ...
  const LIST_IMAGES_DEMO = [images, images, images];
  //
  ...
  const renderSectionContent = () => {
    return (
      <div className="space-y-7 2xl:space-y-8">
        ...
        <div>Đăng bởi: {props.data.seller} </div>
        <div className="flex space-x-3.5">
          ...
          <ButtonPrimary className="flex-1 flex-shrink-0">
            ...
            <a href={"tel:" + props.data.phone} className="ml-3">
              {" "}
              Gọi điện - {props.data.phone}
            </a>
          </ButtonPrimary>
        </div>
